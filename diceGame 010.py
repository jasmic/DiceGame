...
#When it is a draw, throw again to find the winner
...
#Announce the winner and control a draw
#this code needs testing in a separate file
#set playertotals to the same number and run the code
#this will mimic a draw

if Player1total==Player2total:
    print("\nIt's a draw!")
    print("\nThrow a dice, highest number thrown wins!")
    while Player1total==Player2total:
        start = input("\nPlayer 1, press enter to roll the dice!")
        throw1 = random.randint(1,6)
        Player1total=Player1total+throw1
        start = input("\nPlayer 2, press enter to roll the dice!")
        throw2 = random.randint(1,6)
        Player2total=Player2total+throw2
        print("\nPlayer 1, You threw a",throw1)
        print("\nPlayer 2, You threw a",throw2)
        if throw1 == throw2:
            print("\nIt's another draw! Throw again...")
        elif throw1>throw2:
            print("\nPlayer 1 is the winner!")
            print("\nPlayer 1, your total score is",Player1total)
        else:
            print("\nPlayer 2 is the winner!")
            print("\nPlayer 2, your total score is",Player2total)
